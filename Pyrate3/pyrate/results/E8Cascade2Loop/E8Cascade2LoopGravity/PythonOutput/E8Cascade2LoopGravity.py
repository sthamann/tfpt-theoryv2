...
from RGEs import (beta_g1, beta_g2, beta_g3,
                  beta_Yu, beta_Yd, beta_Ye, beta_yN1, beta_yN2, beta_yN3,
...
class RGEsolver():
    ...
    def __init__(self, name, initialScale = 0, tmin = 0, tmax = 20):
        ...
        self.yN1 = Coupling('yN1', 'Yukawas', shape=(3,1))
        self.yN2 = Coupling('yN2', 'Yukawas', shape=(3,1))
        self.yN3 = Coupling('yN3', 'Yukawas', shape=(3,1))
    ...
    def betaFunction(self, t, couplingsArray):
        ...
        Yu, Yd, Ye, yN1, yN2, yN3 = self.extractCouplings(couplingsArray, 'Yukawas')
        ...
        bg1, bg2, bg3 = 3*[0]
        bYu, bYd, bYe, byN1, byN2, byN3 = 6*[0]
        blambda_, blPhi, blHphi = 3*[0]
        bmu2, bMPhi = 2*[0]
        bvSM, bvPQ = 2*[0]

        if self.loops['GaugeCouplings'] >= 1:
            bg1 += beta_g1(1, g1,g2,g3,Yu,Yd,Ye,yN1,yN2,yN3)*self.kappa(1)*np.log(10)
            bg2 += beta_g2(1, g2,g1,g3,Yu,Yd,Ye,yN1,yN2,yN3)*self.kappa(1)*np.log(10)
            bg3 += beta_g3(1, g3,g1,g2,Yu,Yd)*self.kappa(1)*np.log(10)
        if self.loops['GaugeCouplings'] >= 2:
            bg1 += beta_g1(2, g1,g2,g3,Yu,Yd,Ye,yN1,yN2,yN3)*self.kappa(2)*np.log(10)
            bg2 += beta_g2(2, g2,g1,g3,Yu,Yd,Ye,yN1,yN2,yN3)*self.kappa(2)*np.log(10)
            bg3 += beta_g3(2, g3,g1,g2,Yu,Yd)*self.kappa(2)*np.log(10)

        if self.loops['Yukawas'] >= 1:
            bYu += beta_Yu(1, g1,g2,g3,Yu,Yd,Ye,yN1,yN2,yN3,lambda_,lHphi)*self.kappa(1)*np.log(10)
            bYd += beta_Yd(1, g1,g2,g3,Yu,Yd,Ye,yN1,yN2,yN3,lambda_,lHphi)*self.kappa(1)*np.log(10)
            bYe += beta_Ye(1, g1,g2,Yu,Yd,Ye,yN1,yN2,yN3,g3,lambda_,lHphi)*self.kappa(1)*np.log(10)
            byN1 += beta_yN1(1, g1,g2,Yu,Yd,Ye,yN1,yN2,yN3,g3,lambda_,lHphi)*self.kappa(1)*np.log(10)
            byN2 += beta_yN2(1, g1,g2,Yu,Yd,Ye,yN1,yN2,yN3,g3,lambda_,lHphi)*self.kappa(1)*np.log(10)
            byN3 += beta_yN3(1, g1,g2,Yu,Yd,Ye,yN1,yN2,yN3,g3,lambda_,lHphi)*self.kappa(1)*np.log(10)
        if self.loops['Yukawas'] >= 2:
            bYu += beta_Yu(2, g1,g2,g3,Yu,Yd,Ye,yN1,yN2,yN3,lambda_,lHphi)*self.kappa(2)*np.log(10)
            bYd += beta_Yd(2, g1,g2,g3,Yu,Yd,Ye,yN1,yN2,yN3,lambda_,lHphi)*self.kappa(2)*np.log(10)
            bYe += beta_Ye(2, g1,g2,Yu,Yd,Ye,yN1,yN2,yN3,g3,lambda_,lHphi)*self.kappa(2)*np.log(10)
            byN1 += beta_yN1(2, g1,g2,Yu,Yd,Ye,yN1,yN2,yN3,g3,lambda_,lHphi)*self.kappa(2)*np.log(10)
            byN2 += beta_yN2(2, g1,g2,Yu,Yd,Ye,yN1,yN2,yN3,g3,lambda_,lHphi)*self.kappa(2)*np.log(10)
            byN3 += beta_yN3(2, g1,g2,Yu,Yd,Ye,yN1,yN2,yN3,g3,lambda_,lHphi)*self.kappa(2)*np.log(10)

        if self.loops['QuarticTerms'] >= 1:
            blambda_ += beta_lambda_(1, g1,g2,Yu,Yd,Ye,yN1,yN2,yN3,lambda_,lHphi,g3)*self.kappa(1)*np.log(10)
            blPhi += beta_lPhi(1, lPhi,lHphi,g1,g2,Yu,Yd,Ye,yN1,yN2,yN3)*self.kappa(1)*np.log(10)
            blHphi += beta_lHphi(1, g1,g2,Yu,Yd,Ye,yN1,yN2,yN3,lambda_,lPhi,lHphi,g3)*self.kappa(1)*np.log(10)
        if self.loops['QuarticTerms'] >= 2:
            blambda_ += beta_lambda_(2, g1,g2,Yu,Yd,Ye,yN1,yN2,yN3,lambda_,lHphi,g3)*self.kappa(2)*np.log(10)
            blPhi += beta_lPhi(2, lPhi,lHphi,g1,g2,Yu,Yd,Ye,yN1,yN2,yN3)*self.kappa(2)*np.log(10)
            blHphi += beta_lHphi(2, g1,g2,Yu,Yd,Ye,yN1,yN2,yN3,lambda_,lPhi,lHphi,g3)*self.kappa(2)*np.log(10)

        if self.loops['ScalarMasses'] >= 1:
            bmu2 += beta_mu2(1, g1,g2,Yu,Yd,Ye,yN1,yN2,yN3,lambda_,lHphi,mu2,MPhi,g3)*self.kappa(1)*np.log(10)
            bMPhi += beta_MPhi(1, lPhi,lHphi,mu2,MPhi,g1,g2,Yu,Yd,Ye,yN1,yN2,yN3)*self.kappa(1)*np.log(10)
        if self.loops['ScalarMasses'] >= 2:
            bmu2 += beta_mu2(2, g1,g2,Yu,Yd,Ye,yN1,yN2,yN3,lambda_,lHphi,mu2,MPhi,g3)*self.kappa(2)*np.log(10)
            bMPhi += beta_MPhi(2, lPhi,lHphi,mu2,MPhi,g1,g2,Yu,Yd,Ye,yN1,yN2,yN3)*self.kappa(2)*np.log(10)

        if self.loops['Vevs'] >= 1:
            bvSM += beta_vSM(1, g1,g2,Yu,Yd,Ye,yN1,yN2,yN3,vSM,self.xiGauge,g3,lambda_,lHphi)*self.kappa(1)*np.log(10)
            bvPQ += beta_vPQ(1, lPhi,lHphi,vPQ)*self.kappa(1)*np.log(10)
        if self.loops['Vevs'] >= 2:
            bvSM += beta_vSM(2, g1,g2,Yu,Yd,Ye,yN1,yN2,yN3,vSM,self.xiGauge,g3,lambda_,lHphi)*self.kappa(2)*np.log(10)
            bvPQ += beta_vPQ(2, lPhi,lHphi,vPQ)*self.kappa(2)*np.log(10)

        return [bg1, bg2, bg3, *bYu.flat, *bYd.flat, *bYe.flat, *byN1.flat, *byN2.flat, *byN3.flat, blambda_, blPhi, blHphi, bmu2, bMPhi, bvSM, bvPQ]
