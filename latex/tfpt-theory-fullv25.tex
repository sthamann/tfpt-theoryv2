...
% Inlined (standalone build): formerly \input{../tfpt-suite/theoryv3/out/theoryv3_manifest_summary.tex}
% -----------------------------------------------------------------------------
...
% Inlined (standalone build): formerly \input{../tfpt-suite/theoryv3/out/theoryv3_manifest_table.tex}
% -----------------------------------------------------------------------------
% AUTO-GENERATED by tfpt-suite/theoryv3/theoryv3_manifest.py — do not edit by hand.
\begin{table}[H]
\centering
